...
const faqItems = [
  {
    question: 'От кого и как происходят массовые выплаты физическим лицам?',
  ...
  },
  {
    ...
    answer: 'Да, мы предоставляем все необходимые документы и чеки для каждой транзакции'
  },
  {
    question: 'По какому курсу вы работаете?',
    answer: 'Мы используем актуальный рыночный курс Rapira с минимальной комиссией. Курс обновляется в режиме реального времени.'
  },
  {
